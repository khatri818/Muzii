...
class AppColors {
  static const Color black = Color(0xff1F1C1C);
  ...
  static const Color orange = Color(0xffF3671F);
  static const Color grey = Color(0xff999999);
  static const Color orangeLight = Colors.orangeAccent;
  static const Color primary = Color(0xff072985);
  ...
  static const Color secondary = Color(0xffFFBC42);
